...
> 💡 **종합 교차 참조**: 22차 두 사건은 AI 확장이 두 세계에서 동시 진행 중임을 보여준다 — 물리 세계(로봇 양산 자본)에서는 가속, 인간 세계(노동 진입)에서는 사회 비용 실증. [모델 동향](models-overview.md)의 온디바이스·물리 AI 모델 경쟁, [연구 동향](research-overview.md) 9차의 η-learning(기후 리스크 정량화)까지 결합하면, 2026년 하반기 산업 서사는 '성능 경쟁'을 넘어 **'물리·사회 통합의 비용과 수익 구조'**로 이동하고 있다.
