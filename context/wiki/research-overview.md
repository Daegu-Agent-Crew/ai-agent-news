...
## 분석
평가 체계의 표준화는 에이전트 생태계가 성숙하고 있음을 보여준다. FAPO의 실패 분류(Retrieval/Cascade/Format/Reasoning)와 벤치마크의 다단계 평가가 같은 맥락이다. 오픈웨이트(GLM-5.2 91점)와 클로즈드 모델(100점)의 격차가 9점으로 좁혀지고 있다.
