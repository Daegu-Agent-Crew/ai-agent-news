...
## 왜 중요한가?
Google이 모델 자체를 “에이전트용"으로 최적화하고 있습니다. 커스텀 도구 전용 엔드포인트, 단계별 사고 깊이 조절 등은 에이전트가 더 똑똑하게 도구를 쓰게 만드는 핵심 기능입니다. 특히 Flash-Lite의 저렴한 가격은 에이전트를 대량으로 돌리는 서비스에 직접적인 비용 절감 효과가 있습니다.
...
### 관련 뉴스
- [Cisco FAPO](../records/2026-06-20-cisco-fapo-prompt-optimization.md) — Gemini 벤치마크 비교 대상
- [Agentic AI Benchmarks 2026](../records/2026-06-18-agentic-benchmarks-2026.md) — 모델 성능 평가
- [Huawei HarmonyOS 7](../records/2026-06-13-huawei-harmonyos-7-ai-agents.md) — 경쟁 온디바이스 AI
