...
## 왜 중요한가?
프롬프트 최적화는 에이전트 개발에서 가장 시간이 많이 드는 작업입니다. 지금까지는 개발자가 수동으로 프롬프트를 수정하며 테스트해야 했는데, FAPO는 이 과정을 자동화합니다. 특히 “어느 단계에서 문제가 생겼는지" 자동으로 찾아주는 기능은 에이전트 품질을 크게 높일 수 있습니다. 오픈소스라 누구나 쓸 수 있다는 점도 중요합니다.
